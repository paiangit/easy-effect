      ...
      <Panel header="背景设置" key="1" className="site-collapse-custom-panel">
        <Form.Item label="尺寸">
          <SizeInput
            ...
            onChange={setBackgroundConfig as (value: SizeValue) => void}
          ></SizeInput>
        </Form.Item>
        <Form.Item label="背景">
          <Input
      ...
      <Panel header="动效编辑" key="2" className="site-collapse-custom-panel">
        <Form.Item label="尺寸">
          <SizeInput
            ...
            onChange={setAnimationStyle as (value: SizeValue) => void}
          ></SizeInput>
        </Form.Item>
        {texts &&
          texts.map(text => {
        ...
        {assets &&
          assets.map((asset, index) => {
            return (
              <Form.Item label="图片" valuePropName="fileList" key={asset.id}>
                <div
                ...
                <Upload
                  name="logo"
                  beforeUpload={e => beforeUpdate(e, index)}
                  listType="picture"
